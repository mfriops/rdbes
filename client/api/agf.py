...
class AgfService:
    ...
    def get_landings(self, date_from: str, date_to: str) -> Dict[str, Any]:

        if date_from is None or date_to is None:
            raise ValueError("Data from and to may not be empty")

        query = 'date_from=' + str(date_from) + '&date_to=' + date_to
        endpoint = f"/landings?{query}"
